  ...
  return (
    <div className="flex-1 space-y-4 p-8 pt-6">
      ...
      <Tabs defaultValue="overview" className="space-y-4">
        <TabsList>
          <TabsTrigger value="overview">Last 24 Hours</TabsTrigger>
        ...
        <TabsContent value="overview" className="space-y-4">
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">0.01s</div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">0.007%</div>
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
            ...
            <Card className="col-span-3">
              <CardHeader>
                ...
                <CardDescription>Recently logged in accounts.</CardDescription>
              </CardHeader>
              <CardContent>
                <RecentLogin />
              </CardContent>
