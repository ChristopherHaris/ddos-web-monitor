    ...
    <div className="flex-1 space-y-4 p-8 pt-6">
      ...
      <Tabs defaultValue="produk" className="space-y-4">
        <TabsList>
          ...
          <TabsTrigger value="produk-jenis">Produk Jenis</TabsTrigger>
        </TabsList>

        {/* untuk pindah tab ubah TabsContent aja sesuai value produk sama produk-jenis */}
        ...
        <TabsContent value="produk-jenis" className="space-y-4">
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-medium">
